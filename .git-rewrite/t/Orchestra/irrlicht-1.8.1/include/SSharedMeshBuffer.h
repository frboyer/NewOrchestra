...
namespace scene
{
	...
	struct SSharedMeshBuffer : public IMeshBuffer
	{
		...
		virtual void append(const void* const vertices, u32 numVertices, const u16* const indices, u32 numIndices) { /*UNREFERENCED_PARAMETER*/ (vertices); (numVertices); (indices); (numIndices); }

		//! append the meshbuffer to the current buffer
		virtual void append(const IMeshBuffer* const other) { /*UNREFERENCED_PARAMETER*/ (other); }
