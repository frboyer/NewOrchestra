...
namespace gui
{
	...
	public:
		...
		virtual void setActiveIcon(ECURSOR_ICON iconId) { /*UNREFERENCED_PARAMETER*/ (iconId); }
		...
		virtual ECURSOR_ICON addIcon(const gui::SCursorSprite& icon) { /*UNREFERENCED_PARAMETER*/ (icon); return gui::ECI_NORMAL; }
		...
		*/
		virtual void changeIcon(ECURSOR_ICON iconId, const gui::SCursorSprite& sprite) { /*UNREFERENCED_PARAMETER*/ (iconId); (sprite); }

		//! Return a system-specific size which is supported for cursors. Larger icons will fail, smaller icons might work.
		virtual core::dimension2di getSupportedIconSize() const { return core::dimension2di(0,0); }

		//! Set platform specific behavior flags.
		virtual void setPlatformBehavior(ECURSOR_PLATFORM_BEHAVIOR behavior) { /*UNREFERENCED_PARAMETER*/ (behavior); }
