...
public:
	...
	void destruct(T* ptr)
	{
		(ptr); //Visual C++ bug closed as "won't fix": Visual C++ gives unexpected warning C4100 on explicit call to object destructor http://connect.microsoft.com/VisualStudio/feedback/details/435574/visual-c-gives-unexpected-warning-c4100-on-explicit-call-to-object-destructor
		ptr->~T();
	}
