...
public:
	...
	virtual void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
		bool resetAllRenderstates, IMaterialRendererServices* services) { /*UNREFERENCED_PARAMETER*/ (material); (lastMaterial); (resetAllRenderstates); (services); }
	...
	virtual bool OnRender(IMaterialRendererServices* service, E_VERTEX_TYPE vtxtype) { /*UNREFERENCED_PARAMETER*/ (service); (vtxtype); return true; }
